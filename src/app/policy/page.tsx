...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <p className="mb-4">
        We may collect personal information such as your name, email address, phone number, and any other information you provide while using our services.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">4. Third-Party Disclosure</h2>
      <p className="mb-4">
        We do not sell, trade, or otherwise transfer your personal information to outside parties unless we provide users with advance notice.
      </p>
      <h2 className="text-2xl font-semibold mt-6 mb-2">5. Changes to This Privacy Policy</h2>
      <p className="mb-4">
