...
const CompanyOverview = () => {
  ...
  return (
    <section className="company-album-container py-10 px-5 bg-white max-w-[1440px] mx-auto">
      {/* Album Section */}
      <div className="relative mb-6"> {/* Increased bottom margin for spacing */}
        <Image
          src={images[currentImage]}
          alt={`Image ${currentImage + 1}`}
          className="rounded-lg shadow-lg mb-4 transition-transform duration-300 transform hover:scale-105" // Increased bottom margin for image spacing
          width={650}
          height={840}
        />
      ...
      <div className="company-overview flex-grow pl-0 mb-2"> {/* Reduced bottom margin */}
