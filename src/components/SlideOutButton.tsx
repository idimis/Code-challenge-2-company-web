  ...
  return (
    <>
      ...
      >
        ...
        <ul className="flex flex-col items-center justify-center h-3/4 space-y-8 text-2xl md:text-3xl font-bold">
          <li>
        ...
        <div className="absolute bottom-10 w-full flex justify-center space-x-4 md:space-x-8">
